...
/***************************************
 * Function: __gv_test_valid_ast_pointer
 * Description:
 * Input:
 * Output:
 ***************************************/
...
/***************************************
 * Function:__gv_description_from_type
 * Description:
 * Input:
 * Output:
 ***************************************/
static inline char *__gv_description_from_type(int tipo) {
    ...
    switch (tipo) {
        ...
        case AST_LIT_INTEGER:   return "INTEGER";
        case AST_LIT_TRUE:      return "TRUE";
        case AST_LIT_FALSE:     return "FALSE";
        case AST_LIT_CHAR:      return "CHAR";
        case AST_LIT_STRING:    return "STRING";
        case AST_FUN_DEF:       return "AST_FUN_DEF";
        ...
        case AST_NDEC:          return "NDEC";
        case AST_POINTER_DEC:   return "POINTER_DEC";
        case AST_ARRAY_DEC:     return "ARRAY_DEC";
		case AST_ATRR_LIT:      return "ATRR LIT";
		case AST_PARAM_REF:     return "PARAM REF";
		case AST_PARAM:         return "PARAM";
		case AST_LIST:          return "CMD LIST";
